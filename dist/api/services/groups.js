...
var attributes = ['id', 'name', 'createdAt', 'description', 'imageUrl'];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    group = _a.sent();
                    if (!group) {
                        throw boom_1.notFound('group not found', { groupId: groupId });
                    }
                    result = group.toJSON();
...
function getGroups(userContext, limit, offset) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var invitations, allCount, allGroups, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    allGroups = _a.sent();
                    results = allGroups.map(function (g) {
                        var group = g.toJSON();
                        var userGroupData = userContext.groups[group.id];
                        var result = __assign(__assign({}, group), { userInGroup: !!userGroupData });
                        if (result.userInGroup) {
                            result.isAdmin = userGroupData.isAdmin;
                        }
                        else {
                            result.invitationRequested = false;
                            var invitation = invitations.find(function (i) { return i.groupId === group.id; });
                            if (invitation) {
                    ...
                    return [4 /*yield*/, Promise.all(results.map(function (group) { return __awaiter(_this, void 0, void 0, function () {
                            var _a, _b;
...
function createGroup(userContext, data) {
    return __awaiter(this, void 0, void 0, function () {
        var existingGroup, newGroup, playerData, newPlayer, userPlayerData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, models_1.default.groups.findOne({
                        where: {
