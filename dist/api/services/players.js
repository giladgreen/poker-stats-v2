...
var attributes = ['id', 'name', 'email', 'groupId', 'createdAt', 'imageUrl', 'videoUrl'];
var defaultValues = {
    email: '',
};
function getPlayer(_a) {
    var groupId = _a.groupId, playerId = _a.playerId;
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    player = _b.sent();
                    if (!player) {
                        throw boom_1.notFound('player not found', { groupId: groupId, playerId: playerId });
                    }
...
function getPlayers(groupId, userId, limit, offset) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var allCount, allPlayers, usersPlayers, results;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, Promise.all(allPlayers.map(function (p) { return __awaiter(_this, void 0, void 0, function () {
                            var player, userPlayer, user;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        player = p.toJSON();
                                        userPlayer = usersPlayers.find(function (us) { return us.playerId === player.id; });
...
function createPlayer(groupId, data) {
    return __awaiter(this, void 0, void 0, function () {
        var existingPlayer, newPlayerData, newPlayer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 2];
                case 4:
                    newPlayerData = __assign(__assign(__assign({}, defaultValues), data), { groupId: groupId });
                    return [4 /*yield*/, models_1.default.players.create(newPlayerData)];
                case 5:
                    newPlayer = _a.sent();
                    return [2 /*return*/, getPlayer({ groupId: groupId, playerId: newPlayer.id })];
            }
        });
    });
}
function updatePlayer(groupId, playerId, data) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getPlayer({ groupId: groupId, playerId: playerId })];
                case 1:
                    _a.sent();
                    // @ts-ignore
                ...
                case 2:
                    // @ts-ignore
                    _a.sent();
                    return [2 /*return*/, getPlayer({ groupId: groupId, playerId: playerId })];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    userPlayer = _a.sent();
                    if (userPlayer) {
                        throw boom_1.badRequest('you can not delete yourself.', { groupId: groupId, userId: userId, playerId: playerId });
                    }
                ...
                case 2:
                    gamesCount = _a.sent();
                    if (gamesCount > 0) {
                        throw boom_1.badRequest('you can not delete player, remove it from existing games first.', { groupId: groupId, playerId: playerId, gamesCount: gamesCount });
                    }
                    // @ts-ignore
